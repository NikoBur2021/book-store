            ...
            <ThemeProvider theme={theme}>
                <Router>
                    ...
                    >
                        ...
                        <List>
                            <ListItem button>
                                <ListItemText component={Link} to="/" primary={"FIRST PAGE"}>
                                </ListItemText>
                            </ListItem>
                            <ListItem button>
                                <ListItemText component={Link} to="/books" primary={"BOOKS"}>
                                </ListItemText>
                            </ListItem>
                            <ListItem button>
                                <ListItemText component={Link} to="/authors" primary={"AUTHORS"}>
                                </ListItemText>
                            </ListItem>
                        </List>
                    </Drawer>
